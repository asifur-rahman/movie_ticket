...
$msg ='';$msg2 ='';$msg3 ='';$msg4 ='';$msg5 ='' ;$msg6 ='';$msg7 ='';$msg8 ='';$msg9 ='';$price='';$email='';$msg10 ='';
...
/*  $price=$_POST['price'];*/
  ...
  $quantity=$_POST['seatno'];
   ...
   elseif (empty($quantity)) {
     $msg3="<div class='error'>Please enter your quantity of tickets</div>";
   }

   else{
        if( mysqli_query($con,"INSERT INTO ticket
          (name,contact,mail,atime,dob,mname,price,seatno)
          VALUES('$name','$contact','$email','$date','$atime','$mname','$quantity') ")){
$msg9="<div class='success'><center> You are successfully registered </center></div>";

        }else{
          $msg10="<div class='success'><center>" .mysqli_error($con)."</center></div>";
  ...
  <div class="login-form col-md-4 offset-md-4">
    <div class="jumbotron" style="margin-top : 20px;">
     ...
     <div class="form-group">
      ...
      <input type="submit" name="submit" value="Payment Method" class="btn btn-warning">
